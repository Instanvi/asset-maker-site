      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        ...
        <div className="mt-14 pt-8 border-t border-[var(--surface-dark-border)] flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-6">
            <Link href="/#demo" className="hover:text-slate-300 transition-colors">Privacy Policy</Link>
            <Link href="/#demo" className="hover:text-slate-300 transition-colors">Terms of Use</Link>
          </div>
        </div>
      </div>
    </footer>
